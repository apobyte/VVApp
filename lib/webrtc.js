...
/** Backend signaling port on the VPS. Frontend is on 8001. */
export const SIGNALING_PORT = 8002;

export function getWsUrl() {
  if (typeof window === "undefined") return "";
  // Same host as the website, backend port 8002
  return `ws://${window.location.hostname}:${SIGNALING_PORT}/ws`;
}
